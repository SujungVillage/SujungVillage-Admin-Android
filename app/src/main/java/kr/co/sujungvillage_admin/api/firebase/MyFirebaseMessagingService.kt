package kr.co.sujungvillage_admin.api.firebase // ktlint-disable package-name
...
import kr.co.sujungvillage_admin.SplashActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?) {
        Log.d("SEND_REGISTRATION", "sendRegistrationTokenToServer($token)")
    }
